...
if "__MAIN__":
    ...
    nb = Notebook("CLASSMATE", "100 PAGES", "ABC123", 99)
    nb = Notebook("BHASKAR", "200 PAGES", "XYZ123", 199)
    nb = Notebook("TILDA", "300 PAGES", "ABC567", 299)
    ...
    #this is only applicable for notebooks
